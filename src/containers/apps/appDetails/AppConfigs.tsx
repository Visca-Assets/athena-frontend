        ...
        return (
            <div>
                <h4>
                    ...
                    <NewTabLink url="https://platform.visca.ai/docs/app-configuration.html#persistent-or-not">
                        <InfoCircleOutlined />
                    </NewTabLink>
                </h4>
                <div
        ...
        return (
            <div>
                <h4>
                    ...
                    <NewTabLink url="https://platform.visca.ai/docs/app-configuration.html#environment-variables">
                        <InfoCircleOutlined />
                    </NewTabLink>
                </h4>
                ...
                <h4>
                    Port Mapping &nbsp;
                    <NewTabLink url="https://platform.visca.ai/docs/app-configuration.html#port-mapping">
                        <InfoCircleOutlined />
                    </NewTabLink>
                </h4>
                <div
                ...
                <Row>
                    <Col span={24}>
                        <h4>
                            Pre-Deploy Script
                            <NewTabLink url="https://platform.visca.ai/docs/pre-deploy-script.html">
                                <InfoCircleOutlined
                ...
                <Row>
                    <Col span={24}>
                        <h4>
                            ...
                            <NewTabLink url="https://platform.visca.ai/docs/service-update-override.html">
                                <InfoCircleOutlined
                                    style={{ paddingLeft: 10 }}
                                />
                            </NewTabLink>
  ...
  "TaskTemplate": {
    ...
    "Args": [
        "top"
                ...
                <h4>
                    Service Tags &nbsp;
                    <NewTabLink url="https://platform.visca.ai/docs/app-configuration.html#service-tags">
                        <InfoCircleOutlined />
                    </NewTabLink>
                </h4>
