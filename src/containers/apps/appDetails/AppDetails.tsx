            ...
            content: (
                <div>
                    ...
                    <p className={allVolumes.length ? '' : 'hide-on-demand'}>
                        ...
                        if any of the volumes are being used by other Visca
                                ...
                                content: (
                                    <div>
                                        <p>
                                            ...
                                            the{' '}
                                            <NewTabLink url="https://platform.visca.ai/docs/persistent-apps.html#removing-persistent-apps">
                                                documentation
                                            </NewTabLink>{' '}
                    ...
                    if (element.appName === self.props.match.params.appName) {
                        self.setState({
                            ...
                            apiData: {
                                ...
                                athenaSubDomain: data.athenaSubDomain,
